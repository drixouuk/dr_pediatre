...
const TENANT_DOMAIN = 'dr-guinane.dr-tabibi.ma'
const SUPERADMIN_EMAIL = 'admin@dr-tabibi.ma'
const DOCTOR_EMAIL = 'dr.guinane@dr-tabibi.ma'
  ...
  const localeData: Record<string, { title: string; description: string }[]> =
    {
      ...
      en: [
        ...
        },
        {
          ...
          description:
            'Personalized advice for balanced nutrition at every age',
        },
        {
      ...
      ar: [
        {
          ...
          description:
            'متابعة النمو، منحنيات النمو، نصائح الرضاعة والتغذية',
        },
        {
          title: 'التطعيمات',
          description:
            'جدول التطعيم الكامل وفق البرنامج الوطني المغربي',
        },
        {
          title: 'المتابعة الدورية',
          description:
            'فحوصات صحية سنوية، متابعة مدرسية، التطور النفسحركي',
        },
        {
        ...
        },
        {
          ...
          description:
            'نصائح شخصية لتغذية متوازنة في كل مرحلة عمرية',
        },
        {
          title: 'الشهادات الطبية',
          description:
            'شهادات صحية، لياقة رياضية، دور الحضانة والمدارس',
        },
      ],
      tzm: [
        {
        ...
        },
        {
          title: 'ⵜⵉⵏⴼⵍⵉⵜⵉⵏ',
          description:
            'ⴰⵖⴰⵏⵉⴱ ⵏ ⵜⵏⴼⵍⵉⵜ ⴰⵎ ⵓⵖⴰⵏⵉⴱ ⴰⵎⴰⵜⵜⵓⵔ ⴰⵎⴰⵖⵔⵉⴱⵉ',
        },
        {
          title: 'ⴰⵙⴻⴽⵛⴷ ⴰⵎⴰⵜⵓ',
          description:
            'ⵜⵉⴼⵔⴰⵏⵉⵏ ⵏ ⵓⵣⵔⴼ ⴰⵙⴳⴳⴰⵙ, ⴰⵙⴻⴽⵛⴷ ⵏ ⵜⵖⵓⵔⵉ, ⴰⵏⵏⵉⵔⵉ ⴰⵥⴰⵡⴰⵏ',
        },
        {
          title: 'ⴰⵙⵏⵉⵊⵉ ⵏ ⵜⵎⵔⴰⵖⵜ',
          description:
            'ⵜⴰⵖⵣⵉ, ⵜⵉⵎⵙⴰⵍ ⵏ ⵉⴼⴰⵙⵙⵏ, ⵜⵉⵎⵙⴰⵍ ⵏ ⵉⵎⵉ ⴷ ⵉⵎⵣⵣⵓⵖⵏ, ⵜⴰⵖⵣⵉⵎⵜ',
        },
        {
          title: 'ⵜⴰⵍⵍⴻⵙⵜ ⵏ ⵉⵣⴷⴰⵏⵏ',
          description:
            'ⵜⵉⵏⴰⵜⵉⵏ ⵉ ⵜⴰⵍⵍⴻⵙⵜ ⵜⴰⵎⵣⴷⴰⵢⵜ ⴷⴻⴳ ⴽⵓⵍ ⴰⵣⵎⵣ',
        },
        {
          title: 'ⵜⵉⵣⵔⴰⵡⵉⵏ ⵏ ⵓⵣⵔⴼ',
          description:
            'ⵜⵉⵣⵔⴰⵡⵉⵏ ⵏ ⵓⵣⵔⴼ, ⵜⴰⵖⵓⵍⵜ ⵏ ⵓⵖⵔⴱⴰⵣ, ⵜⵉⵖⵉⵡⴰⵏⵉⵏ ⵏ ⵉⵖⵔⴱⴰⵣⵏ',
        },
      ],
    }
