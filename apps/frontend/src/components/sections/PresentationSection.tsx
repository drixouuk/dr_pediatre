...
export default async function PresentationSection({ locale }: Props) {
  ...
  return (
    <section id="presentation" className="scroll-mt-20 bg-gradient-to-b from-cream-100 to-white bg-white bg-[length:100%_16px] bg-[position:0_0] bg-no-repeat px-4 py-20 md:px-6 md:py-28 lg:px-8">
