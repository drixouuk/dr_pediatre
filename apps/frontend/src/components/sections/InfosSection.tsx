...
export default async function InfosSection({ locale }: Props) {
  ...
  return (
    <section
      id="infos"
      className="scroll-mt-24 bg-gradient-to-b from-cream-100 to-white bg-white bg-[length:100%_64px] bg-[position:0_0] bg-no-repeat px-4 py-12 md:px-6 md:py-16 lg:px-8"
    >
